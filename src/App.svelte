...
<section class="intro">
  ...
  <h1> National elections worldwide during 2020 & 2021, in charts</h1>
...
<article class="scrolls">
  ...
  <section class="textblocks">
    ...
    <p class="para last">A quick overview of national elections in the last two years shows that no single trend defines elections during the pandemic, with repercussions having more subtle effects on countries across the political spectrum.</p>
  </section>
  <section class="textblocks">
    <h3>Data sources</h3>
    <p class="para small">
