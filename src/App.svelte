...
<section class="intro">
  <h1> Elections between 2020 and September 2021</h1>
...
<article class="scrolls">
  <section class="step" id="step-1">
    <p>Between March 2020 and September 2021, elections were held in 82 countries. In total, 101 elections were held, with 16 countries having held multiple elections during this period. Seventeen countries at some point had <span class="postponed">postponed</span> the election.</p>
    {#if width > 920}
  ...
  <section class="textblocks">
    <h2>How electoral participation changed during the pandemic?</h2>
      ...
      <p class="para">
         A few countries held elections with quite a low turnout, which was affected by many factors, not only related to the pandemic. One example is Algeria, where a referendum proposing constitutional changes was held in November 2020. Many <a href="https://www.aljazeera.com/news/2020/11/1/algeria-votes-on-referendum-aimed-at-ending-protest-movement" target="_blank">criticized</a> the referendum, pointing out that country's ultra presidential regime will not change. The opposition movement called for a boycott of the vote.
      </p>
      <p class="para">
      ...
      <p class="para">
        Several elections attracted much more voters than previous elections, despite the pandemic. For example, Burundi held elections to replace President Pierre Nkurunziza, who had ruled the country for 15 years. A <a href="https://www.nytimes.com/2020/05/20/world/africa/burundi-election.html" target="_blank">competitive</a> race to elect a new president attracted  many voters, despite the widespread violence that accompanied the election.
      </p>
      <p class="para last">
  ...
  <div class="chart" id="turnout-stringency-chart" bind:this={width}>
    ...
    <article class="scrolls">
      ...
      <p class="step" id="turnout-step-2">Turnout difference in comparison to the previous election has a slightly stronger association with stringency measures. In countries with more stringent policies, fewer voters showed at the polls compared to the last election. Approximately half of all elections between March 2020 and September 2021 had lower, or the same turnout as in the previous election and had a higher stringency index.
      </p>
  ...
  <section class="textblocks">
    <h2 class="title-turnout-strigency">Did incumbents <span class="hyb">win</span> or <span class="lost">loose</span> more frequently?</h2>
    <p class="para">During the times of international crisises, citizens tend to unite behind their leaders and the support for the government is expected to increase. This a phenomenon known in political science literature as a "rally-round-the-flag" effect. Incumbents won in more than a half of elections held during the pandemic. Recent studies found "rally around the flag" effect in <a href="https://www.tandfonline.com/doi/full/10.1080/01402382.2021.1925017" target="_blank"> Austria, </a> and across <a href="https://www.pnas.org/content/pnas/early/2020/09/23/2009252117.full.pdf" target="_blank">11 different countries,</a> showing that political leaders got a boost in approval, especially in the early months of the pandemic. </p>
  </section>
  <div class="chart" bind:this={width}>
